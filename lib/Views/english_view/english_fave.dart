...
class EnglishFavPage extends StatefulWidget {
  const EnglishFavPage({super.key});

  @override
  State<EnglishFavPage> createState() => _EnglishFavPageState();
}

class _EnglishFavPageState extends State<EnglishFavPage> {
  @override
