...
class EnglishVersePage extends StatefulWidget {
  const EnglishVersePage({super.key});

  @override
  State<EnglishVersePage> createState() => _EnglishVersePageState();
}

class _EnglishVersePageState extends State<EnglishVersePage> {
  bool istapped = false;
